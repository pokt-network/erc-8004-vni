...
- **Validator** — an individual signing key or address selected by a validation network for a specific request. Validators produce the [EIP-712](./eip-712.md) attestations included in the aggregated response.
